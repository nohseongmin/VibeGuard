...
![tests: 56 passing](https://img.shields.io/badge/tests-56%20passing-brightgreen.svg)
...
- 출력 형식: 터미널, JSON, Markdown, SARIF(GitHub 코드 스캐닝/VS Code). 브라우저 GUI(`vibeguard gui`)와 베이스라인(기존 코드 수용 후 새 문제만 보고)도 지원합니다.
